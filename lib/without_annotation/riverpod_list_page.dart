...
class TodoListNotifier extends StateNotifier<List<Todo>> {
  TodoListNotifier() : super([]) {
    ...
    addTodo(Todo(id: 1, content: wordPair.asPascalCase, completed: false));
  }
...
class RiverpodListPage extends ConsumerWidget {
  ...
  static const pageName = 'Riverpod Todo List without annotations Page';
  static const routeName = '/without_annotation/riverpod_list_page';
  final String title;
